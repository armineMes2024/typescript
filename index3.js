...
function filterPhonesByDate(phones, key, initial) {
    ...
    return phones
        .filter(function (phone) { return phone[key] instanceof Date; })
        .filter(function (phone) { return phone[key] > initialDate; })
        .map(function (phone) { return (__assign(__assign({}, phone), { initialDate: initial })); });
}
